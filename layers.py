...
class TaskContainer:
    def __init__(self, input_shape, output_size, name='Unique_layer', optimizer=SGD, lr=0.0001, loss='binary_crossentropy'):
    ...
    def create_task_like_this(self):
        task = TaskContainer(self.input_shape, self.output_size, self.name, self.optimizer, self.learningrate, self.loss)
        return task
