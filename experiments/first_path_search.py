...
for iteration in range(1, repeates+1):
    ...
    path1, fit1, log1 = ps.binary_mnist_tournamet_search(x1, y1, first_task, stop_when_reached=accuracy_threshold)
    ...
    path2, fit2, log2 = ps.binary_mnist_tournamet_search(x2, y2, second_task, stop_when_reached=accuracy_threshold)
